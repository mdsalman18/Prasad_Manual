...
const AddNewBatch2 = () => {
  ...
  return (
    <div className="flex">
      <aside className="h-screen w-72 bg-gradient-to-br fixed from-black to-gray-900 p-6 shadow-lg">
      ...
      <div className="ml-72 flex-1 p-10 bg-gradient-to-br from-black to-gray-900 shadow-inner rounded-lg text-white">
        <Outlet />
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 w-1/2 mx-auto gap-6 text-center"></div>
