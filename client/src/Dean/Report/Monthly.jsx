...
const Monthly = () => {
    ...
    const students = [
        ...
        { rollNo: 5, name: 'John Doe', fathersName: 'Mr. Doe', attendance: [22, 18, 20, 25, 20, 22, 23, 21, 22, 19, 20, 23] },
        { rollNo: 6, name: 'Jane Smith', fathersName: 'Mr. Smith', attendance: [25, 20, 21, 23, 19, 21, 22, 18, 20, 24, 22, 19] },
        { rollNo: 7, name: 'Michael Brown', fathersName: 'Mr. Brown', attendance: [20, 10, 30, 16, 23, 20, 22, 11, 25, 25, 20, 10] },
        { rollNo: 8, name: 'Emily Davis', fathersName: 'Mr. Davis', attendance: [25, 22, 11, 25, 19, 21, 22, 22, 23, 21, 22, 19] }
    ];
