...
class AttendanceBase(models.Model):
    ...
    roll_number = models.ForeignKey(Phase2Student, on_delete=models.CASCADE)
...
class Pathology(AttendanceBase):
    class Meta:
        unique_together = ('roll_number', 'date')

class Microbiology(AttendanceBase):
    class Meta:
        unique_together = ('roll_number', 'date')

class Pharmacology(AttendanceBase):
    class Meta:
        unique_together = ('roll_number', 'date')
